...
urlpatterns = [
    ...
    url(r'^EditProfile/(?P<uuid>\d+)$', views.EditRiderPage, name="EditRider"),
    ...
    url(r'^EditEvent/(?P<uuid>\d+)$', views.EditEventPage, name="EditEvent"),
    url(r'^UpdateEvent/(?P<id>\d+)$', views.UpdateEvent, name="UpdateEvent"),
    url(r'^ImageUpload/(?P<id>\d+)$', views.ImageUpload, name="ImageUpload")
